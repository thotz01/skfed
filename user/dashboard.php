...
// Add this query to get total residents count
$query = "SELECT COUNT(*) as total FROM residents";
$result = mysqli_query($conn, $query);
$row = mysqli_fetch_assoc($result);
$totalResidents = $row['total'];

// Add at the top of your file with other queries
$barangay_query = "SELECT COUNT(*) as total FROM barangay";
$barangay_result = mysqli_query($conn, $barangay_query);
$barangay_count = mysqli_fetch_assoc($barangay_result);
$totalBarangays = $barangay_count['total'];

// Add at the top of your file with other queries
$posts_query = "SELECT COUNT(*) as total FROM posts";
$posts_result = mysqli_query($conn, $posts_query);
$posts_count = mysqli_fetch_assoc($posts_result);
$totalPosts = $posts_count['total'];
?>
                ...
                <div class="card welcome-banner">
                  ...
                  <div class="card-body">
                    <div class="d-flex align-center">
                      <h1>Hello, <?php echo ucfirst($_SESSION['username']); ?>  <img src="../assets/images/dashboard-1/hand.png" alt=""/></h1>
                    </div>
                ...
                <div class="card earning-card">
                  <div class="card-header pb-0 card-no-border">
                    <div class="header-top">
                      ...
                      <div class="dropdown">
                        <button class="btn dropdown-toggle" id="userdropdown3" type="button" data-bs-toggle="dropdown" aria-expanded="false">Today</button>
                  ...
                  <div class="card-body pt-2">
                    <ul class="d-flex align-center justify-content-center gap-3"> 
                      <li>
                        <div class="d-flex gap-2"> 
                          ...
                          <div class="flex-grow-1"> 
                            <h3><?php echo number_format($totalResidents); ?></h3>
                            <p>Total Residents</p>
                          </div>
                        </div>
                      </li>
                      <li>
                        <div class="d-flex gap-2"> 
                          ...
                          <div class="flex-grow-1"> 
                            <h3><?php echo number_format($totalBarangays); ?></h3>
                            <p>Total Barangays</p>
                          </div>
                        </div>
                      </li>
                    ...
                    <div class="table-responsive theme-scrollbar">
                      <table class="table display" style="width:100%">
                        ...
                        <tbody>
                          <?php
                          $query = "SELECT * FROM barangay ORDER BY created_at DESC LIMIT 3";
                          $result = mysqli_query($conn, $query);
                          ...
                          if ($result && mysqli_num_rows($result) > 0) {
                              ...
                              ?>
                              <tr>
                                  <td colspan="4" class="text-center">No barangay records found</td>
                              </tr>
                              <?php
                          }
                          ?>
    ...
    var options = {
        series: [{
            ...
            data: [
                ...
                $monthlyQuery = "SELECT 
                    DATE_FORMAT(bdate, '%M') as month,
                    COUNT(*) as count 
                    FROM residents 
                    GROUP BY DATE_FORMAT(bdate, '%M')
                    ORDER BY bdate ASC
                    LIMIT 6";
