                                ...
                                <div class="posts-grid">
                                    ...
                                    if ($result->num_rows > 0) {
                                        while($row = $result->fetch_assoc()) {
                                            ...
                                            <div class="post-card">
                                                ...
                                                <div class="post-content">
                                                    ...
                                                    <div class="post-actions">
                                                        <a href="#" class="edit-btn" data-bs-toggle="modal" data-bs-target="#editPostModal<?php echo $row['id']; ?>">
                                                            <svg><use href="../assets/svg/icon-sprite.svg#edit-content"></use></svg>
                                                        </a>
                                                        <a href="add-post.php?action=delete&id=<?php echo $row['id']; ?>" 
                                            ...
                                            <!-- Add Edit Modal for each post -->
                                            <div class="modal fade" id="editPostModal<?php echo $row['id']; ?>" tabindex="-1" aria-hidden="true">
                                                <div class="modal-dialog modal-lg">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            <form id="editPostForm<?php echo $row['id']; ?>" action="add-post.php" method="POST" enctype="multipart/form-data">
                                                                <input type="hidden" name="post_id" value="<?php echo $row['id']; ?>">
                                                                <input type="hidden" name="edit_post" value="1">
                                                                
                                                                <div class="form-group">
                                                                    <label for="post_title">Title</label>
                                                                    <input type="text" name="post_title" class="form-control" value="<?php echo htmlspecialchars($row['post_title']); ?>" required>
                                                                </div>
                                                                
                                                                <div class="form-group mt-3">
                                                                    <label for="post_description">Description</label>
                                                                    <textarea name="post_description" class="form-control" rows="4"><?php echo htmlspecialchars($row['post_description']); ?></textarea>
                                                                </div>
                                                                ...
                                                                <div class="form-group mt-3">
                                                                    ...
                                                                    <?php if(!empty($row['post_image'])): ?>
                                                                        <div class="current-image mb-2">
                                                                            <img src="../<?php echo $row['post_image']; ?>" alt="Current Image" style="max-height: 100px;">
                                                                        </div>
                                                                    <?php endif; ?>
                                                                ...
                                                                <div class="form-group mt-3">
                                                                    ...
                                                                    <select name="post_category" class="form-control">
                                                                        ...
                                                                        foreach($categories as $category) {
                                                                            $selected = ($row['post_category'] == $category) ? 'selected' : '';
                                                                ...
                                                                <div class="form-group mt-3">
                                                                    ...
                                                                    <select name="post_priority" class="form-control">
                                                                        ...
                                                                        foreach($priorities as $priority) {
                                                                            $selected = ($row['post_priority'] == $priority) ? 'selected' : '';
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="submit" form="editPostForm<?php echo $row['id']; ?>" class="btn btn-primary">Save Changes</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
