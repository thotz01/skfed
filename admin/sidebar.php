        ...
        <div class="main-sidebar" id="main-sidebar">
            <ul class="sidebar-menu" id="simple-bar">
                ...
                <li class="sidebar-list">
                    ...
                    <ul class="sidebar-submenu">
                        <li><a href="add-residents.php">Add Resident</a></li>
                        <li><a href="add-post.php">Add Post</a></li>
                        <li><a href="list-register.php">List Register</a></li>
                        <!-- <li><a href="add-barangay.php">Add Barangay</a></li> -->
                    </ul>
                </li>
                <li class="sidebar-list">
                    <i class="fa-solid fa-thumbtack"></i>
                    ...
                    <ul class="sidebar-submenu">
                        <li><a href="users-profile.php">Users Profile</a></li>
                        <!-- <li><a href="users-accounts.php">Users Accounts</a></li> -->
